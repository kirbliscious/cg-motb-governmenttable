jQuery(function($){
	...
	/*----------------- Distribute Flags - http://stackoverflow.com/questions/10152390/dynamically-arrange-some-elements-around-a-circle*/
	...
	function positionCards(_flag){
		var $flag = _flag,
			...
			flag_pos_x = roundUp(flag_pos.left,1),
			flag_pos_y = roundUp(flag_pos.top,1),
			dy = flag_pos_x - center_x,
			dx = flag_pos_y - center_y;
			var theta = Math.atan2(dy,dx);
			theta *= 180 / Math.PI;

			var cards_pos_x = flag_pos_x + $flag.width()/2;
			var cards_pos_y = flag_pos_y + $flag.height()/2;
